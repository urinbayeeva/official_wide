    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: const PreferredSize(
            preferredSize: Size.fromHeight(0), child: Divider(color: AppColors.cefefef, thickness: 1)),
      ),
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Container(
                    decoration:
                        const BoxDecoration(border: Border(bottom: BorderSide(width: 1, color: AppColors.cefefef))),
                    child: const Padding(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                "Topilov_1",
                                style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18, color: AppColors.c1c1c1c),
                              ),
                              SizedBox(height: 4),
                              Text(
                                "Salomat.uz dan video keldi",
                                style: TextStyle(fontWeight: FontWeight.w600, fontSize: 12, color: AppColors.c707071),
                                maxLines: 1,
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                "2 min ago",
                                style: TextStyle(color: AppColors.c707071, fontSize: 12, fontWeight: FontWeight.w400),
                              ),
                              SizedBox(height: 4),
                              CircleAvatar(
                                radius: 8,
